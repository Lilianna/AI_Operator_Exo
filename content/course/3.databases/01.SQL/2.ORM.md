...
This a way to interact with your database using a language of your choice (say Python) instead of SQL.
...
To properly use an ORM you will need to do more research, don't limit yourself to what it is written in this README, it only showed you half of the basics.
